...
const containerinfo2 = ({route, navigation }) => {
...
onPress={() => {setvehicledata(''); navigation.navigate('CarDetails',{'datapre':item.id, 'imgs':item.images})}}
>
...
{/* <ImageBackground source={require('../images/bg.png')} resizeMode='stretch' style={{ width: '100%', height:'100%', position: 'absolute' }} > */}
