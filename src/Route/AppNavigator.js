...
import serviceDetails from '../screens/servicesDetails';
import Trackandtrace from '../screens/Trackandtrace';
import AsyncStorage from '@react-native-community/async-storage';
import SplashScreen from '../screens/SplashScreen';
import temp from '../screens/temp';
import containerinfo2 from '../screens/containerinfo2';
...
console.log(AppConstance.IS_USER_LOGIN);
const [value , setvalue] = useState(AppConstance.IS_USER_LOGIN)
useEffect(() => {

  AsyncStorage.getItem('ISUSERLOGIN').then((value) => {
    if (value == '1') {
 ...
 return (
  ...
  options={{headerShown:false,gestureEnabled: false, drawerLockMode: 'locked-closed' ,             swipeEnabled: false  
...
/>
  ...
  <Stack.Screen name='Dashboardmain' component={Dashboardmain}  options={{headerShown:false,gestureEnabled: false}}  />
  ...
  <Stack.Screen name='containerinfo2' component={containerinfo2}  options={{headerShown:false,}} />
  ...
  <Stack.Screen name='Trackandtrace' component={Trackandtrace} options={{headerShown:false}} />
